      ...
      <div class="folder-table">
        <div class="button-group">
          <template v-if="folderButtonsState !== 0">
            <el-button-group>
              <el-button type="primary" round plain :icon="Download" @click="folderButton(1)">下载</el-button>
              <template v-if="folderButtonsState === 1">
                <el-button type="primary" round plain :icon="EditPen" @click="folderButton(2)">重命名</el-button>
              </template>
              <el-button type="primary" round plain :icon="Rank" @click="folderButton(3)">移动</el-button>
              <el-button type="primary" round plain :icon="CopyDocument" @click="folderButton(4)">复制</el-button>
              <el-button type="danger" round plain :icon="DeleteFilled" @click="folderButton(5)">删除</el-button>
            </el-button-group>
          </template>
        </div>
